...
function Initialize()
	...
	for i = 0, num-1 do
		table.insert(t, "" .. doSub(key, i) .. "" .. "=" .. doSub(value, i))
		local j = 0

	end

	file:write("[MusicDots]", "\n", "Meter=Shape", "\n","DynamicVariables=1","\n","UpdateDivider=#FreezeVisualizerMeters#","\n","Shape=Ellipse ((#Radius#+([MeasureBand0]*#JumpHeight#))*cos(rad(#degree0#))+#CentreX#),((#Radius#+([MeasureBand0]*#JumpHeight#))*sin(rad(#degree0#))+#CentreY#),#DotRadius#|Stroke Color #Color1#")
